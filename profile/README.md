...
## 📖 개요
지비(ZIBI)는 청약 정보를 쉽고 편리하게 확인할 수 있도록 만든 **청약 종합 플랫폼**입니다.  
청약 과정은 복잡하고 준비해야 할 서류·조건이 매우 다양해, 처음 도전하는 사람들에게는 높은 진입장벽이 존재합니다. 우리는 이러한 불편함을 해소하고자, **가점 계산·계좌 연동·선호 조건에 따른 추천·실시간 공고 확인·당첨 확률 예측**까지 한 번에 해결할 수 있는 웹앱을 개발했습니다.  
